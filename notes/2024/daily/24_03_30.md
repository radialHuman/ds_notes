...
- created several popular LLMs such as AlpahMonarch-7B, Beyonder-4x7B, Phixtral, and NeuralBeagle14, along with releasing essential LLM tools like LLM AutoEval, LazyMergekit, LazyZxolotl, and AutoGGUF. 
